...
public final class StatusCode {
    ...
    static {
        status.put(SYSTEM_BUSY, "系统繁忙");
        status.put(SUCCESS, "请求成功");
        ...
        status.put(40027, "不合法的子菜单按钮URL");
        status.put(40028, "不合法的自定义菜单使用用户");
        status.put(40029, "不合法的qt_code");
        ...
        status.put(50002, "未授权的域名");
        status.put(70001, "非法计费项、操作或无该计费项权限");
        status.put(70002, "非法计费对象");
        status.put(70003, "可消费余量不足");
        status.put(70004, "超出本次允许最大消费量");
    }
